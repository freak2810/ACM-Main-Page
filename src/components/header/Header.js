...
export default function Header(props) {
    ...
    return <Helmet>
        ...
        <link href={`%PUBLIC_URL%/logo.png`} rel="apple-touch-icon"/>
        ...
        <meta property="og:image" content={`%PUBLIC_URL%/websiteShot.png`}/>
        ...
        <meta property="twitter:description"
              content="ACM MVSR is a subsidiary of Association for Computing Machinery (ACM), a worldwide learning society for computing. The chapter was founded on August 2, 2019."/>
        <meta property="twitter:image" content={`%PUBLIC_URL%/websiteShot.png`}/>
